 ...
 * - Ana Lobon Roldan
 * - Juan Lara Gavira
 * DESCRIPCION: Clase LlamadasHelper que determina el cominezo de una llamada 
 *              y el establecimiento de la llamada (cliente origen con cliente
 *              destino).
 */
...
/*
// VERIFICACION PROPIA DEL FICHERO LLAMADASHELPER.
//
