 ...
 * - Ana Lobon Roldan
 * - Juan Lara Gavira
 * DESCRIPCION: Fichero que recoge las funciones necesarias para el correcto calculo
 *              del porcentaje de paquetes correctos y del retardo medio.  
 */
...
double Observador::GetMediaCorrectos()
{
  ...
  if(numPaquetesEnviados == 0)
  ...
  else
    {
      ...
      mediaCorrectos = double (paquetesCorrectos) / numPaquetesEnviados;
    }
